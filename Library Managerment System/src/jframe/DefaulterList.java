...
public class DefaulterList extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(DefaulterList.class.getName());
    ...
    public void setIssueBookDetailsToTable() {
        ...
        try {
            ...
            PreparedStatement pst = con.prepareStatement("Select * from issue_book_details due_Date < ? and status = ?");
